...
export default function FilterByCapacity() {
  ...
  return (
    <div className="flex border border-primary-800 ">
      <Button onClick={() => handleClick("all")}>All cabins</Button>
      <Button onClick={() => handleClick("small")}>1&mdash;3</Button>
      <Button onClick={() => handleClick("medium")}>4&mdash;8</Button>
      <Button onClick={() => handleClick("large")}>9&mdash;12</Button>
    </div>
  );
}
